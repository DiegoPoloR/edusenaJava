...
public class AlertaContraseña extends javax.swing.JFrame {

    
    private coordinador miCoordinador;
    int MouseX;
    int MouseY;
    public AlertaContraseña() {
        initComponents();
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout AlterJpHeaderLayout = new javax.swing.GroupLayout(AlterJpHeader);
        AlterJpHeader.setLayout(AlterJpHeaderLayout);
        AlterJpHeaderLayout.setHorizontalGroup(
            AlterJpHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 380, Short.MAX_VALUE)
        );
        AlterJpHeaderLayout.setVerticalGroup(
            AlterJpHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 35, Short.MAX_VALUE)
        );

        JpBg.add(AlterJpHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 380, 35));

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Aceptar");
        JpBg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 100, 30));
        ...
        JpBg.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 100, 30));
        ...
        txtAlertaa.setText("Por favor digite una contraseña");
        JpBg.add(txtAlertaa, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 340, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaContraseña.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertaContraseña().setVisible(true);
            }
        });
    }
