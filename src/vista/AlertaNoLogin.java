...
public class AlertaNoLogin extends javax.swing.JFrame {

    
    private coordinador miCoordinador;
    int MouseX;
    int MouseY;
    public AlertaNoLogin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtAlertaa.setText("Usuario/Contraseña incorrecto.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaNoLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertaNoLogin().setVisible(true);
            }
        });
    }
